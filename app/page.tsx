...
const questions = [
  ...
  {
    type: "text",
    question: "Who are your favorite authors? (You can list multiple)",
    name: "authors",
    maxLength: 100,
  },
  {
  ...
  },
  {
    type: "text",
    question:
      "What type of story are you in the mood for (e.g., adventure, romance, mystery)?",
    name: "storyType",
    maxLength: 100,
  },
  {
    type: "text",
    question:
      "Are there any specific themes or topics you enjoy (e.g., dystopian, space exploration)?",
    name: "themes",
    maxLength: 100,
  },
];
...
export default function Home() {
  ...
  const handleAnswer = (answer: string) => {
    const newAnswers = {
      ...answers,
      [questions[currentQuestionIndex].name]: answer,
    };
  ...
  return (
    <div className="flex flex-col text-black justify-center items-center min-h-screen bg-gray-100">
      <div className="w-full max-w-3xl flex flex-col  bg-white p-8 h-full   rounded-lg shadow-lg ">
        <h1 className="text-2xl font-bold mb-6 text-center shadow-md py-2">
          Book Suggestion App
        </h1>
        <div className=" flex flex-col justify-end shadow-md p-2 text-sm  rounded h-[30dvh]">
        ...
        {isCompleted && (
          <div className="mt-6 text-sm">
            ...
            {loading ? (
              ...
              <>
                <div className="font-bold my-4 text-lg shadow-md p-2 rounded">
